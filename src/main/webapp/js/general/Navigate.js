(function() {
	...
	var processFirstEnter = function() {
		var userToken = '';

		// if (!userToken && !window.location.pathname.startsWith('/welcome')) {
		// 	var searchedPath = window.location.pathname.substring(1);
		// 	window.location.href = '/welcome' + (searchedPath ? '?r=' + window.location.pathname.substring(1) : '');
		// 	return true;
		// } else if (window.location.pathname.length <= 2) {
		// 	window.location.href = '/home';
		// 	return true;
		// } else if (userToken && window.location.pathname.startsWith('/welcome')) {
		// 	window.location.href = '/' + (Navigate.extractParameter('r') || 'home');
		// 	return true;
		// }
